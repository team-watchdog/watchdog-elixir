        ...
        <main>
            <div className="container">
                <div className="py-10">
                    ...
                    <p className="py-2">Thank you for reaching out in this critical time! We have forwarded your pledge to our partner organizations, and they will reach out to you and coordinate the next steps. In the meantime, read our article on how to contribute during this crisis here: <a href="https://longform.watchdog.team/data-projects/how-to-donate-to-the-sri-lankan-medical-crisis" className="text-blue-1 font-semibold">How to donate to the Sri Lankan medical crisis.</a></p>
