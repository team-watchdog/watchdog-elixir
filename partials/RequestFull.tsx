    ...
    return (
        <div className="flex flex-col py-4">
            ...
            <div className="py-4 px-6 bg-yellow-0 rounded-md mb-4">
                ...
                <p className="mb-2">Please feel free to go through the list and follow the instructions of the procedure to donate. If you have any queries do not hesitate to contact me via this email.</p>
            </div>
        </div>
    )
}